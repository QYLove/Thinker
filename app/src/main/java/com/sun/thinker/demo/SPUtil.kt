...
fun getSP(name:String) =
    ThinkerApp.getInstance()
        .getSharedPreferences(name,Context.MODE_PRIVATE)!!

fun SharedPreferences.getSPEditor() = this.edit()!!

fun SharedPreferences.spApplyClear() =
    getSPEditor().clear().apply()

fun SharedPreferences.spCommitClear() =
    getSPEditor().clear().commit()

fun SharedPreferences.spApplyInt(key:String,value:Int) =
...
fun SharedPreferences.spGetInt(key: String,defValue:Int) =
...
fun SharedPreferences.spGetLong(key: String,defValue:Long = 0L):Long =
...
fun SharedPreferences.spGetFloat(key: String,defValue:Float = 0F) =
...
fun SharedPreferences.spApplyRemove(key: String) =
    getSPEditor().remove(key).apply()

fun SharedPreferences.spCommitRemove(key: String) =
    getSPEditor().remove(key).commit()