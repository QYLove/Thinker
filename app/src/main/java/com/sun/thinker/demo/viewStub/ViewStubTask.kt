...
abstract class ViewStubTask(val decorView: View) {
    ...
    private fun setUpViewStub(viewStub: ViewStub) {
        ...
        val proxyListener: ViewStub.OnInflateListener =
            ViewStub.OnInflateListener { stub, inflated ->
    ...
    /**
     * 使用 ViewStub ，建议使用findViewById,
     * 如果直接调用Activity 或者 根布局的findViewById，
     * 当我们的view还没有add进入的时候，
     * 这时候会为null
     */
